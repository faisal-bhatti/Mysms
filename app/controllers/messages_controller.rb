class MessagesController < ApplicationController
  ...
  def create
    ...
    if @message.save
      ...
      message = api.messages.build( :to => '03324167729', :from=>"Decent-Acad", :content => 'Test Session of 9th & 10th are started. Contact at 03324167729. Decent Academy' )
